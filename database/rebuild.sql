...
-- Paso 1 Create client_type data type
CREATE TYPE public.account_type AS ENUM ('Client', 'Employee', 'Admin');
ALTER TYPE public.account_type OWNER TO cse340smv;


-- PASO 2  Table structure for table `classification`
...
-- PASO 3 Table structure for table 'inventory'
...
-- PASO 5 Table structure for table `account`
...
-- PASO 6 Data for table 'classification'
...
-- PASO 7 Data for table `inventory`
